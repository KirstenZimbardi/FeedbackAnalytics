...
```{r, echo=FALSE}
#first plot with legend at top
default.plot()
par(oma = c(0, 0, 1.5, 0))

uqm.plot1(ls1=ls.annot.audio, main1="Number of audio annotations", ylab1="annotations per report", ls2=ls.annot.text, main2="Number of text annotations",  ylab2="annotations per report")

par(fig = c(0, 1, 0, 1), oma = c(0, 0, 0, 0), mar = c(0, 0, 0, 0), new = TRUE)
plot(0, 0, type = "n", bty = "n", xaxt = "n", yaxt = "n")
legend("top", legend = sem.names,  xpd = TRUE, horiz = TRUE, inset = c(0, 0), fill = sem.col, bty="n")
...
plot.mean.sem(FbP.AcP, 4, 14, 20, report.col, report.names)
plot.mean.sem(FbP.AcP, 5, 14, 20, report.col, report.names)
...
Figure 2 Box plots of the number of audio and text feedback provision annotations for level 1 course (Report 1: n=1576, Report 2: n=1634, Report 3: n=1604, Report 4: n=707 and for the level 2 course (Report 1: n=333, Report 2: n=330). Shown is the A) Average number of audio annotations per report across two semesters of level 1 and 2 subjects; B) Average number of text annotations per report across two semesters of level 1 and 2 subjects.
