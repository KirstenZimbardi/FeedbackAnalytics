...
write.csv(demog.df, file="demog.csv", row.names=FALSE)

write.csv(AcP.biol.df, file="AcPbioldf.csv", row.names=FALSE)
write.csv(AcP.biom.df, file="AcPbiomdf.csv", row.names=FALSE)
write.csv(AcP.df, file="AcPdf.csv", row.names=FALSE)
write.csv(AcP.open.bins, file="AcPFbUbins.csv", row.names=FALSE)

write.csv(FbP.df, file = "FbPdf.csv", row.names=FALSE)
write.csv(FbP.summary, file = "FbPsummary.csv", row.names=FALSE)

write.csv(FbU.df, file = "FbUdf.csv", row.names=FALSE)
#write.csv(df, file = "FbUdfWOwithdrawals.csv", row.names=FALSE)

write.csv(studs.withdrew, file = "withdrawals.csv", row.names=FALSE)
write.csv(remarks.subID, file = "remarks.csv", row.names=FALSE)
